...
import { ThemeProvider, COLORS } from "@/contexts/ThemeContext";
...
export default async function RootLayout({
  ...
  let initialTheme = { color: 'mint' as ColorTheme };
  try {
    const settings = await getSystemSettings(['theme_color']);
  ...
  return (
    <html lang="en" className="antialiased" suppressHydrationWarning>
      ...
      <body style={styleVariables} className="min-h-dvh flex flex-col text-[var(--foreground)] selection:bg-[#92D0C6]/30 bg-[var(--background)] overflow-x-hidden">
