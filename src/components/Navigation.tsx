  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-[#D1EAE5] px-4 py-2.5 shadow-[0_4px_16px_rgba(165,207,201,0.2)]">
      <div className="mx-auto max-w-7xl flex items-center justify-between">
        {/* Brand Logo */}
        <Link href="/" className="flex items-center gap-2 text-xl sm:text-2xl font-black text-[#4A6B65] hover:opacity-85 transition-opacity">
          <svg className="w-7 h-7 sm:w-8 sm:h-8 text-[#58A498]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex items-center gap-2.5">
          <Link 
            href="/words" 
            title="単語管理"
            className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full bg-[#E0F2EF] hover:bg-[#C6E7E1] text-[#4A6B65] transition-all shadow-[0_4px_12px_rgba(165,207,201,0.3)] hover:shadow-[0_6px_16px_rgba(165,207,201,0.4)] hover:-translate-y-0.5 active:translate-y-0 active:shadow-[0_2px_8px_rgba(165,207,201,0.3)]"
          >
          ...
          <Link 
            href="/wallpapers" 
            title="壁紙管理"
            className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full bg-[#E4F3FA] hover:bg-[#BAE2F5] text-[#4A6B65] transition-all shadow-[0_4px_12px_rgba(186,226,245,0.4)] hover:shadow-[0_6px_16px_rgba(186,226,245,0.5)] hover:-translate-y-0.5 active:translate-y-0 active:shadow-[0_2px_8px_rgba(186,226,245,0.4)]"
          >
