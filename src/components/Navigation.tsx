...
export default function Navigation() {
  return (
    <nav className="sticky top-0 z-50 w-full bg-[var(--card-bg)]/80 backdrop-blur-md border-b border-[#D1EAE5] px-4 py-2.5 shadow-[0_4px_16px_rgba(165,207,201,0.2)]">
      <div className="mx-auto max-w-7xl flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 text-xl font-black text-[#4A6B65] hover:opacity-85 transition-opacity">
          <svg className="w-7 h-7 text-[var(--accent)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex items-center gap-2.5">
          ...
          >
            <svg className="w-5.5 h-5.5 text-[var(--accent)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
          ...
          <Link 
            href="/settings" 
            title="Settings"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-[#F3E8FD] hover:bg-[#E5CFFF] text-[#4A6B65] transition-all shadow-[0_4px_12px_rgba(206,171,255,0.3)] hover:shadow-[0_6px_16px_rgba(206,171,255,0.4)] hover:-translate-y-0.5 active:translate-y-0 active:shadow-[0_2px_8px_rgba(206,171,255,0.3)]"
          >
            <svg className="w-5.5 h-5.5 text-[#9D5CFF]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
